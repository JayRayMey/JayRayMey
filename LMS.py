...
import os
print("""================================================================""")
print("\t\t\tST. MARY'S ENGLISH HIGH SCHOOL")

print("""================================================================""")
print(f"\n------------------------------Welcome To SMEHS's Library Management System---------------------------\n")
print("Designed and Maintained by:\n")
print("\tJEREMY MATHEW JOSE    - XII A1 - 29 [2021-22]")
print("\tSARTHAK MANCHANDA  - XII A1 - 46 [2021-22]")


os.getcwd()  # --> This function is to return the Working directory of a process.
